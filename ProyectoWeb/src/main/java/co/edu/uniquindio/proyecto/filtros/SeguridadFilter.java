...
import co.edu.uniquindio.proyecto.beans.SeguridadBean;
...
public class SeguridadFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
		...
		boolean autenticado = seguridadBean != null && seguridadBean.isAutenticado() && seguridadBean.isEsInmobiliaria();
		if (autenticado) {
